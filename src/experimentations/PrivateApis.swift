...
func SameProcess(_ psn1: UnsafeMutablePointer<ProcessSerialNumber>, _ psn2: UnsafeMutablePointer<ProcessSerialNumber>, _ same: UnsafeMutablePointer<DarwinBoolean>) -> Void
...
func CGSGetWindowBounds(_ cid: CGSConnectionID, _ wid: UnsafeMutablePointer<CGWindowID>, _ frame: UnsafeMutablePointer<CGRect>) -> CGError

// * deprecated in macOS 10.9>, so we have to declare it to use it in Swift
@_silgen_name("GetProcessPID")
func GetProcessPID(_ psn: UnsafeMutablePointer<ProcessSerialNumber>, _ pid: UnsafeMutablePointer<pid_t>) -> Void

// crashed the app with SIGSEGV
// * macOS 10.10+
@_silgen_name("CGSGetWindowType") @discardableResult
func CGSGetWindowType(_ wid: CGWindowID, _ type: UnsafeMutablePointer<UInt32>) -> CGError
...
func CGSGetWindowOwner(_ cid: CGSConnectionID, _ wid: CGWindowID, _ windowCid: UnsafeMutablePointer<CGSConnectionID>) -> CGError

// returns the PSN for the provided connection ID
// * macOS 10.10+
@_silgen_name("CGSGetConnectionPSN") @discardableResult
func CGSGetConnectionPSN(_ cid: CGSConnectionID, _ psn: UnsafeMutablePointer<ProcessSerialNumber>) -> CGError
...
func CGSCopyWindowGroup(_ cid: CGSConnectionID, _ wid: CGWindowID, _ groupType: CFString, _ windowList: UnsafeMutablePointer<CFArray>, _ windowCount: UnsafeMutablePointer<UInt>) -> Void
